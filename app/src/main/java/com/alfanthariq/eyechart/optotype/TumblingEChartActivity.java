...
public class TumblingEChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tumbling_echart);
        ...
        container.setOnTouchListener(new OnSwipeTouchListener(TumblingEChartActivity.this){
    ...
    private void openSetting(){
        Intent intent = new Intent(TumblingEChartActivity.this, SettingsActivity.class);
