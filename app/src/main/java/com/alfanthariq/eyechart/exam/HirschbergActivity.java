...
public class HirschbergActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hirschberg);
        ...
        container.getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        seekBar.setMax(disHeight+300);
                        seekBar.setProgress(mSlider.getHeight());
                    }
                });

        TypedArray imgs = getResources().obtainTypedArray(R.array.hirs);
        ...
        params = new LinearLayout.LayoutParams(disHeight+150, disHeight+300);
        mSlider.setLayoutParams(params);
    }
