...
public class DotTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dot_test);
        ...
        TypedArray imgs = getResources().obtainTypedArray(R.array.dot_test);
