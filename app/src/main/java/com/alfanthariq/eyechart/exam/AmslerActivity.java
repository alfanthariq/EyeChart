...
public class AmslerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amsler);
        ...
        TypedArray imgs = getResources().obtainTypedArray(R.array.amsler);
