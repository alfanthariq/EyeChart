...
public class RedGreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        container.getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        seekBar.setMax(disHeight-100);
                        seekBar.setProgress(mSlider.getHeight());
                    }
                });

        TypedArray imgs = getResources().obtainTypedArray(R.array.red_green);
        ...
        mSlider.addOnPageChangeListener(new ViewPagerEx.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if (position==4) {
                    ...
                    content.setBackgroundColor(getResources().getColor(R.color.bgDark));
                }
            }
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                ...
                params = new LinearLayout.LayoutParams(i, i);
